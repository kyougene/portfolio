...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm("service_3zbyjwy", "contact_form", form.current, {
        publicKey: "q3y3BQFpWSiJ_IKfd",
      })
      .then(
        () => {
          setFormData({
        ...
        <div className="w-1/2 mt-4">
          ...
          <form ref={form} onSubmit={handleSubmit} className="max-w-md mx-auto">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-blue-700 w-full text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              >
                Send
              </button>
            </div>
